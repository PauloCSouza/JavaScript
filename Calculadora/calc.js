...
function calcSin(){ // Função Seno
	
	total = Math.sin(Number(arrayInput()));
	$("#painel").val(total);

}

function calcCos(){ // Função Consseno
	
	total = Math.cos(Number(arrayInput()));
	$("#painel").val(total);

}

function calcTan(){ // Função Tangente
	
	total = Math.tan(Number(arrayInput()));
	$("#painel").val(total);

}

function calcEuler(){ // Função Euler
...
function calcLog(){
	...
	total = Math.log(Number(arrayInput()));
	$("#painel").val(total);
...
function resultCient(operator){ // Função que recebe o ID e chama a função do operador selecionado (Científica)
	...
	switch(operator){
		...
		case 'sin': // Chama a função calcPi e exibe o valor
		...
		case 'cos': // Chama a função calcPi e exibe o valor
		...
		case 'tan': // Chama a função calcPi e exibe o valor
		...
		case 'e': // Chama a função calcPi e exibe o valor
		...
		case 'log': // Chama a função calcPi e exibe o valor
